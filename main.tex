...
excluded. The centered log-ratio (CLR) transformation (Aitchison 1982; Gloor et al.\ 2017)\cite{aitchison1986}\cite{gloor2017}
...
As described in Section~\ref{sec:gmm}, the MixGGM algorithm was applied to both CLR-transformed feature matrices.
