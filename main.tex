...
excluded. The centered log-ratio (CLR) transformation (Aitchison 1982)\cite{aitchison1986}
...
The centered log-ratio (CLR) transformation (Aitchison 1982)\cite{aitchison1986} maps
...
\begin{figure}[H]
  ...
  \includegraphics[width=1\linewidth]{Fig3_Thesis.png}      
    ...
    1982)\cite{aitchison1986}, applied identically to both datasets. Input: sparse
...
\subsection*{(d) Biome Grouping Schemes}
...
%------------------------------------------------------------
\section*{Supplementary Table 6: Random Forest Classification}
\addcontentsline{toc}{section}{Supplementary Table 6}
\label{supp:tab6}
%------------------------------------------------------------
