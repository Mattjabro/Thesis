...
genera\_after\_prevalence\_filter &  & 966 & Genus-resolved lineages retained after prevalence filter (threshold=50); excludes higher-level partial-taxonomy lineages \\
