...
%  Soil Microbiome Community Structure and Typing
%============================================================
...
global topsoil dataset, and 50 for the EMP dataset. Full threshold sweep statistics are provided
...
final\_lineages &  & 1533 & Final number of lineages in CLR-transformed feature matrix (from thesis: 1533 at threshold that gives this count; see Supp Table 3b) \\
...
%------------------------------------------------------------
\section*{Supplementary Table 3: Prevalence Threshold Sweep}
\addcontentsline{toc}{section}{Supplementary Table 3}
\label{supp:tab3}
%------------------------------------------------------------

Prevalence filter threshold sweep results. For each minimum-prevalence cutoff the table
reports the number of genus-level lineages remaining, the percentage of lineages retained
relative to threshold\,=\,1, and the percentage of total read-count abundance retained.
The selected threshold is marked with a checkmark.

\subsection*{(a) Global Topsoil Dataset}

\begingroup\small
\begin{longtable}{rrrrr}
\caption[Prevalence sweep --- Global Topsoil]{Prevalence threshold sweep --- Global Topsoil Dataset. Selected threshold: 20 samples.}
\label{tab:supp3a} \\
\toprule
\textbf{Min.\ Prev.} & \textbf{Lineages} & \textbf{\% Lineages} & \textbf{\% Counts} & \textbf{Selected} \\
\midrule
\endfirsthead
...
\subsection*{(b) EMP Soil Subset}

\begingroup\small
\begin{longtable}{rrrrl}
\caption[Prevalence sweep --- EMP Soil]{Prevalence threshold sweep --- EMP Soil Subset. Selected threshold: 50 samples.}
\label{tab:supp3b} \\
\toprule
\textbf{Min.\ Prev.} & \textbf{Lineages} & \textbf{\% Lineages} & \textbf{\% Matrix} & \textbf{Selected} \\
\midrule
\endfirsthead
