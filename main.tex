...
\begin{table}[H]
\centering
\caption[RF model performance]{Random forest model performance metrics for all dataset and biome label scheme combinations.}
\label{tab:supp6a}
\small
\resizebox{\textwidth}{!}{%
...
\caption[Feature importance top 50]{Top 50 most important genera by Mean Decrease in Accuracy for each random forest model (dataset $\times$ biome label scheme combination).}
\label{tab:supp6b} \\
\toprule
