...
distances geometrically inappropriate and Pearson correlations spurious (Aitchison 1982;
Gloor et al.\ 2017)\cite{aitchison1986}\cite{gloor2017}. Soil microbiome data are
...
Claremont McKenna College (Rocky Linux), managed by SLURM (Yoo et al.\ 2003)\cite{yoo2003}. Compute nodes provide up to
...
The centered log-ratio (CLR) transformation (Aitchison 1982; Gloor et al.\ 2017)\cite{aitchison1986}\cite{gloor2017} maps
...
\begin{figure}[H]
  ...
  \includegraphics[width=1\linewidth]{Fig3_Thesis.png}      
    ...
    Centered log-ratio (CLR) transformation pipeline (Aitchison 1982; Gloor et al.\ 2017)\cite{aitchison1986}\cite{gloor2017}, applied identically to both datasets. Input: sparse
...
Sample clustering was done using a mixture of Gaussian Graphical Models (MixGGM) framework (Yooseph and Tavakoli
...
matrix (global topsoil) and from the genus-collapsed count matrix (EMP): observed operational taxonomic units (OTUs),
...
The MixGGM clustering (Yooseph and Tavakoli 2022)\cite{yooseph2022} identified 19 non-empty
...
(Lozupone and Knight 2007)\cite{lozupone2007}, and the EMP clustering reflects this.
...
(Fierer and Jackson 2006; Lauber et al.\ 2009)\cite{fierer2006}\cite{lauber2009}. Two soils
...
(Thompson et al.\ 2017)\cite{thompson2017}. Cluster~5, with the highest richness,
...
on Earth (Fierer and Jackson 2006)\cite{fierer2006}. The fact that Chao1 richness estimates
...
culture collections (Bergmann et al.\ 2011)\cite{bergmann2011}. Verrucomicrobiota are
...
type and soil organic matter quality (Navarrete et al.\ 2015)\cite{navarrete2015}. The fact that
...
and vitamin auxotrophies (Brewer et al.\ 2017)\cite{brewer2017}. Its abundance is highest
in grassland soils and it is thought to rely on nutrients released by neighboring organisms
rather than synthesizing them \textit{de novo} (Willms et al.\ 2020)\cite{willms2020}. The
...
waterlogged soils (Treude et al.\ 2003; Thomas et al.\ 2008)\cite{treude2003}\cite{thomas2008}.
...
persistence under drought and temperature extremes (Nicholson 2002)\cite{nicholson2002}.
...
(Grady et al.\ 2016)\cite{grady2016}. \textit{Sphingomonas} is a metabolically versatile
genus found across diverse soil environments but often enriched in anthropogenically
disturbed soils (Asaf et al.\ 2020)\cite{asaf2020}. Their high predictive value in the EMP models reflects the inclusion of agricultural and urban soils, where human disturbance favors different microbial functional groups than those found in undisturbed natural environments.
