...
# === Step 6: Save table ===
write_csv(results, file.path(processed_dir, "asv_fraction_vs_lineage_threshold.csv"))
...
ggsave(file.path(fig_dir, "fraction_lineages_remaining_plot.png"), p1, width = 6, height = 4, dpi = 300)
...
ggsave(file.path(fig_dir, "fraction_matrix_remaining_plot.png"), p2, width = 6, height = 4, dpi = 300)
