...
# Load model function
model_fn <- "/hopper/home/syooseph/projects/MPLN/CombinedModelSelection/MS_MixGGM_all.R"
cat("Loading best_model() from:", model_fn, "\n")
source(model_fn)

# Read the CLR matrix for EMP
...
# Save output
outfile <- file.path(outdir, "best_model_emp_k20.RData")
